...
const styles = {
  ...
  pfpOptions:
    "flex flex-row gap-4 justify-center pt-4 rounded-2xl  h-48 full rounded-full  ",
  ...
  pfpOptionsSelected:
    "flex flex-row gap-4 justify-center pt-4 rounded-2xl  h-48 full ",
  ...
  return (
    <>
      ...
      <div className="pfp p-4">
            ...
            return (
              <div key={props.pfp}>
                <Image
                  ...
                  className={
                    selectedPFP === e
                      ? styles.pfpOptionsSelected
                      : styles.pfpOptions
                  }
                  onClick={() => {
                    setSelectedPFP(pfp[i]);
                  }}
                  height={80}
                  width={80}
                />
        ...
        <div className={styles.save} onClick={saveSettings}>
          Save
        </div>
      </div>
    </>
